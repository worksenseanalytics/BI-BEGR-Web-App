...
export function SatkerDetailView() {
  ...
  const cpDetailChartData = useMemo(() => {
    ...
    if (selectedCp === "Sespiok") {
      ...
      data.push({ name: "Keterlibatan", score: activeRecord.keterlibatanSespiok, color: "#a5b4fc" });
      data.push({ name: "Kesesuaian EVP", score: activeRecord.kesesuaianEvpKepemimpinanSespiok, color: "#10b981" });
      data.push({ name: "Kesesuaian Pilar", score: activeRecord.kesesuaianBiPrestasiSespiok, color: "#06b6d4" });
      data.push({ name: "NNS: Trust & Integrity", score: activeRecord.trustIntegritySespiok, color: "#f59e0b" });
      data.push({ name: "NNS: Professionalism", score: activeRecord.professionalismSespiok, color: "#f59e0b" });
      data.push({ name: "NNS: Excellence", score: activeRecord.excellenceSespiok, color: "#f59e0b" });
      data.push({ name: "NNS: Public Interest", score: activeRecord.publicInterestSespiok, color: "#f59e0b" });
      data.push({ name: "NNS: Coordination & Teamwork", score: activeRecord.coordinationTeamworkSespiok, color: "#f59e0b" });
      ...
      data.push({ name: "Keterlibatan", score: activeRecord.keterlibatanAkukeren, color: "#a5b4fc" });
      data.push({ name: "Kesesuaian EVP", score: activeRecord.kesesuaianEvpKepemimpinanAkukeren, color: "#10b981" });
      data.push({ name: "Kesesuaian Pilar", score: activeRecord.kesesuaianBiDigitalAkukeren, color: "#06b6d4" });
      data.push({ name: "NNS: Trust & Integrity", score: activeRecord.trustIntegrityAkukeren, color: "#f59e0b" });
      data.push({ name: "NNS: Professionalism", score: activeRecord.professionalismAkukeren, color: "#f59e0b" });
      data.push({ name: "NNS: Excellence", score: activeRecord.excellenceAkukeren, color: "#f59e0b" });
      data.push({ name: "NNS: Public Interest", score: activeRecord.publicInterestAkukeren, color: "#f59e0b" });
      data.push({ name: "NNS: Coordination & Teamwork", score: activeRecord.coordinationTeamworkAkukeren, color: "#f59e0b" });
      ...
      data.push({ name: "Keterlibatan", score: activeRecord.keterlibatanObf, color: "#a5b4fc" });
      data.push({ name: "Kesesuaian EVP", score: activeRecord.kesesuaianEvpKeluargaObf, color: "#10b981" });
      data.push({ name: "Kesesuaian Pilar", score: activeRecord.kesesuaianBiInovasiObf, color: "#06b6d4" });
      data.push({ name: "NNS: Trust & Integrity", score: activeRecord.trustIntegrityObf, color: "#f59e0b" });
      data.push({ name: "NNS: Professionalism", score: activeRecord.professionalismObf, color: "#f59e0b" });
      data.push({ name: "NNS: Excellence", score: activeRecord.excellenceObf, color: "#f59e0b" });
      data.push({ name: "NNS: Public Interest", score: activeRecord.publicInterestObf, color: "#f59e0b" });
      data.push({ name: "NNS: Coordination & Teamwork", score: activeRecord.coordinationTeamworkObf, color: "#f59e0b" });
      ...
      data.push({ name: "Keterlibatan", score: activeRecord.keterlibatan3h, color: "#a5b4fc" });
      data.push({ name: "Kesesuaian EVP", score: activeRecord.kesesuaianEvpKesejahteraan3h, color: "#10b981" });
      data.push({ name: "Kesesuaian Pilar", score: activeRecord.kesesuaianBiSpiritual3h, color: "#06b6d4" });
      data.push({ name: "NNS: Trust & Integrity", score: activeRecord.trustIntegrity3h, color: "#f59e0b" });
      data.push({ name: "NNS: Professionalism", score: activeRecord.professionalism3h, color: "#f59e0b" });
      data.push({ name: "NNS: Excellence", score: activeRecord.excellence3h, color: "#f59e0b" });
      data.push({ name: "NNS: Public Interest", score: activeRecord.publicInterest3h, color: "#f59e0b" });
      data.push({ name: "NNS: Coordination & Teamwork", score: activeRecord.coordinationTeamwork3h, color: "#f59e0b" });
      ...
      data.push({ name: "Keterlibatan", score: activeRecord.keterlibatanPinter, color: "#a5b4fc" });
      data.push({ name: "Kesesuaian EVP", score: activeRecord.kesesuaianEvpKesejahteraanPinter, color: "#10b981" });
      data.push({ name: "Kesesuaian Pilar", score: activeRecord.kesesuaianBiSpiritualPinter, color: "#06b6d4" });
      data.push({ name: "NNS: Trust & Integrity", score: activeRecord.trustIntegrityPinter, color: "#f59e0b" });
      data.push({ name: "NNS: Professionalism", score: activeRecord.professionalismPinter, color: "#f59e0b" });
      data.push({ name: "NNS: Excellence", score: activeRecord.excellencePinter, color: "#f59e0b" });
      data.push({ name: "NNS: Public Interest", score: activeRecord.publicInterestPinter, color: "#f59e0b" });
      data.push({ name: "NNS: Coordination & Teamwork", score: activeRecord.coordinationTeamworkPinter, color: "#f59e0b" });
    }
  ...
  // Displays score dynamics across the 4 main assessment sessions
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 2. SPECIFIC UNIT HEADER PROFILE BADGES */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
               {/* Unit Identity & CML Badge Card (Tremor-Style) */}
        <div 
          className="md:col-span-1 lg:col-span-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-xl shadow-sm flex flex-col justify-between space-y-4"
        >
            ...
            <div className="relative flex items-center justify-center w-28 h-28">
              <svg className="w-full h-full transform -rotate-90">
                ...
                <circle 
                  ...
                  strokeDashoffset={`${2 * Math.PI * 48 * (1 - (activeRecord.cultureMaturityLevel / 5))}`}
                  strokeLinecap="round"
              ...
              <div className="absolute flex flex-col items-center">
                ...
                <span className="text-[9px] font-bold text-slate-400 tracking-wide">dari 5,00</span>
              </div>
            </div>
          </div>
        ...
        {/* 4. Detail Komponen Penilaian per CP (Tremor-Style) */}
        <div className="md:col-span-2 lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-xl shadow-sm flex flex-col justify-between space-y-4 relative overflow-visible z-20">
          <div>
          ...
          <div className="h-64 w-full relative overflow-y-auto scrollbar-thin pr-1">
            <div style={{ height: `${Math.max(240, cpDetailChartData.length * 30)}px`, width: "100%" }}>
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <XAxis type="number" domain={[dataMin => Math.max(0, dataMin - 0.2), dataMax => Math.min(5, dataMax + 0.2)]} tick={{ fill: "#64748b", fontSize: 10 }} axisLine={false} tickLine={false} tickFormatter={(v) => typeof v === "number" ? parseFloat(v.toFixed(2)).toString() : v} />
                  <YAxis 
                    type="category" 
                    dataKey="name" 
          ...
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={evpChartData} margin={{ top: 10, right: 10, left: -20, bottom: 5 }}>
                ...
                <YAxis domain={[dataMin => Math.max(0, dataMin - 0.2), dataMax => Math.min(5, dataMax + 0.2)]} tick={{ fill: "#64748b", fontSize: 11.5 }} axisLine={false} tickLine={false} tickFormatter={(v) => typeof v === "number" ? parseFloat(v.toFixed(2)).toString() : v} />
                <Tooltip content={<CustomTooltip />} />
      ...
      {/* 4. DAMPAK NNS CORE VALUES BLOCK */}
      <div className="w-full">
        
        {/* 5. Dampak NNS Core Values Horizontal Bars Representation */}
            ...
            {nnsDampakData.map((dmp) => (
              <div key={dmp.name} className="space-y-1.5">
                <div className="flex justify-between items-center text-xs font-bold text-slate-700 dark:text-slate-350">
                  ...
                  <span className="font-sans text-[13px] text-slate-800 dark:text-slate-100">{formatScore(dmp.Skor)} <span className="text-[10px] text-slate-400 font-medium font-sans">/ 5,00</span></span>
                </div>
          ...
          <div className="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 w-full max-w-4xl max-h-[90vh] rounded-[24px] shadow-2xl flex flex-col overflow-hidden z-10 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-5 sm:p-6 overflow-y-auto flex-1 scrollbar-thin">
              <div className="bg-blue-50/40 dark:bg-blue-950/10 p-4 rounded-xl border border-blue-100/30 dark:border-blue-900/20 mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="flex gap-4 text-xs font-extrabold text-slate-500 dark:text-slate-400 shrink-0">
                  <div className="flex items-center gap-1.5">
              ...
              <div className="w-full relative" style={{ height: `${Math.max(450, cpDetailChartData.length * 45)}px` }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart
                    layout="vertical"
                    data={cpDetailChartData}
                  ...
                  >
                    <CartesianGrid strokeDasharray="3 3" horizontal={false} stroke="#f1f5f9" className="dark:stroke-slate-800/40" />
                    <XAxis type="number" domain={[0, 5]} tick={{ fill: "#64748b", fontSize: 11 }} axisLine={false} tickLine={false} tickFormatter={(v) => typeof v === "number" ? parseFloat(v.toFixed(2)).toString() : v} />
                    <YAxis 
                      type="category" 
                      dataKey="name" 
