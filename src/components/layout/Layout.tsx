  ...
  switch (tabId) {
    case "overview":
      return {
        ...
        subtitle: "Analisis Makro Tingkat Kematangan Budaya Kerja Nasional Bank Indonesia"
      };
    case "ranking":
      return {
          ...
          {showLabels ? (
            <div className="flex items-center gap-3 transition-opacity duration-300">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[10px] font-semibold text-[#c7dee9] whitespace-nowrap mt-0.5">
                  {adminUser}
                </p>
              </div>
            </div>
